...
#Config.set('kivy','window_icon','file/cat_icon.ico')
...
MDScreen:
    ...
    MDTopAppBar:
        ...
        title: "Hsu Mei"
        md_bg_color: "#BB5E00"
        right_action_items: [["reload", lambda x: app.reload()], ["menu", lambda x: nav_drawer.set_state("open")]]
...
#------------------------------------------------------------------------------
    ...
    def file_manager_open(self):
        ...
        self.file_manager.show("C:\\Users\\Ding\\Desktop\\HsuMei_code")
